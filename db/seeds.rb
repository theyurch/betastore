...
BetaProduct.create(name: 'hat', description: 'Hat')
BetaProduct.create(name: 'hoodie', description: "Hoodie")
BetaProduct.create(name: 'iphone_case', description: "iPhone case")
BetaProduct.create(name: 'journal', description: "Journal")
BetaProduct.create(name: 'shirt', description: "Shirt")
BetaProduct.create(name: 'sticker', description: "Sticker")
